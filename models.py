...
class User(Model):
    ...
    password = fields.CharField(max_length=255, null=True, unique=True)
...
class Business(Model):
    id = fields.IntField(pk=True, index=True)
    business_name = fields.CharField(max_length=20, null=True, unique=True)
    ...
    logo = fields.CharField(max_length=255, null=True, default="default.jpg")
...
class Product(Model):
    ...
    original_price = fields.DecimalField(max_digits=12, decimal_places=2, null=True)
    ...
    product_image = fields.CharField(max_length=255, null=True, default="productDefault.jpg")
